...
if($flight_details['responsecode'] == '200-success') {
  ...
  <tr class="flight-search-row">
    ...
    <a class="book-this-departure" href="/flights/selected?onward_fid=<?php print $flight_details['onward_fid'];?>&return_fid=<?php print $flight_details['flight_reference_id'][$index];?>&sessID=<?php print $flight_details['sessionID'];?>&searchkey=<?php print $_GET['searchkey'];?>"><img src="<?php print $theme_path; ?>/images/book_this_return.gif" alt="" /></a>
    </span>
...
?>
 ...
 count($flight_details['linked_flight'][$linked_flight_index]['airline_name'])-1; ?>">
  ...
  ?>
    ...
    <span class="book-link-span">
    <a class="book-this-departure" href="/flights/selected?onward_fid=<?php print $flight_details['onward_fid'];?>&return_fid=<?php print $flight_details['flight_reference_id'][$direct_flights_count+$linked_flight_index];?>&sessID=<?php print $flight_details['sessionID']; ?>&searchkey=<?php print $_GET['searchkey'];?>"><img src="<?php print $theme_path; ?>/images/book_this_return.gif" alt="" /></a>
    </span>
   <!-- Fare summary Started -->
