...
function spotonline_preprocess_page(&$vars, $hook) {
  ...
  //drupal_set_message('Hi'.$_GET['q']);
  $theme_path = $base_url . '/' . drupal_get_path('theme', $theme);
  if($_GET['q'] == 'flights/show') {
    drupal_add_js(path_to_theme(). '/js/flights/flight_search_filters.js');
    //drupal_add_js(path_to_theme(). '/js/flights/flightslist.js');
  }
  if($_GET['q'] == 'flights/showreturn') {
    drupal_add_js(path_to_theme(). '/js/flights/return_flightslist.js');
    drupal_add_js(path_to_theme(). '/js/flights/flight_search_filters_return.js'); 
  }
  if($_GET['q'] == 'flights/search' || $_GET['q'] == 'flights/show' || $_GET['q'] == 'flights/showreturn' || $_GET['q'] == 'flights/selected') {
    drupal_add_js(path_to_theme(). '/js/flights/flight_search.js');
    /*drupal_add_js(path_to_theme(). '/js/flights/jquery-1.4.1.min.js');
    drupal_add_css(path_to_theme(). '/css/flights/jquery-ui-1.8rc1.custom.css');
    drupal_add_js(path_to_theme(). '/js/flights/jquery-ui-1.8rc1.custom.min.js');
    drupal_add_css(path_to_theme(). '/css/flights/slider.css');
    drupal_add_css(path_to_theme(). '/css/flights/lightbox.css');*/
  }
  if($_GET['q'] == 'flights/selected') {
    drupal_add_js(path_to_theme(). '/js/flights/flight_review.js');
  }
 if (!empty($user->uid)) {
